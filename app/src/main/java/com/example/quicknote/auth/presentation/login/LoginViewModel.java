...
public class LoginViewModel extends ViewModel {
    ...
    private final MutableLiveData<Response<LoginSuccess, AuthResponse>> _loginStatus = new MutableLiveData<>();
    public LiveData<Response<LoginSuccess, AuthResponse>> loginStatus = _loginStatus;
